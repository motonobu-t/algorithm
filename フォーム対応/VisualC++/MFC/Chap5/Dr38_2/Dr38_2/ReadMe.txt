================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr38_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr38_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr38_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr38_2.h
   ...
   CDr38_2App アプリケーション クラスを宣言します。

Dr38_2.cpp
   これは、アプリケーション クラス CDr38_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr38_2.ico
   ...
   アイコンはメイン リソース ファイル Dr38_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr38_2.rc ファイル内
...
Dr38_2Doc.h, Dr38_2Doc.cpp - ドキュメント
   これらのファイルは CDr38_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr38_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr38_2View.h, Dr38_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr38_2View クラスを含みます。
   CDr38_2View オブジェクトは CDr38_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr38_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
