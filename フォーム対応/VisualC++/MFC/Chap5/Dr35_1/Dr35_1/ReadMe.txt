================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr35_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr35_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr35_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr35_1.h
   ...
   CDr35_1App アプリケーション クラスを宣言します。

Dr35_1.cpp
   これは、アプリケーション クラス CDr35_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr35_1.ico
   ...
   アイコンはメイン リソース ファイル Dr35_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr35_1.rc ファイル内
...
Dr35_1Doc.h, Dr35_1Doc.cpp - ドキュメント
   これらのファイルは CDr35_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr35_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr35_1View.h, Dr35_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr35_1View クラスを含みます。
   CDr35_1View オブジェクトは CDr35_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr35_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
