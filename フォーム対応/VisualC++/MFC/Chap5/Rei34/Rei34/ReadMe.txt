================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei34 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei34 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei34 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei34.h
   ...
   CRei34App アプリケーション クラスを宣言します。

Rei34.cpp
   これは、アプリケーション クラス CRei34App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei34.ico
   ...
   アイコンはメイン リソース ファイル Rei34.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei34.rc ファイル内
...
Rei34Doc.h, Rei34Doc.cpp - ドキュメント
   これらのファイルは CRei34Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei34Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei34View.h, Rei34View.cpp - ドキュメントのビュー
   これらのファイルは CRei34View クラスを含みます。
   CRei34View オブジェクトは CRei34Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei34.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
