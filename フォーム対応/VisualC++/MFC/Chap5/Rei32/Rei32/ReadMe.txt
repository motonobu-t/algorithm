================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei32 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei32 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei32 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei32.h
   ...
   CRei32App アプリケーション クラスを宣言します。

Rei32.cpp
   これは、アプリケーション クラス CRei32App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei32.ico
   ...
   アイコンはメイン リソース ファイル Rei32.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei32.rc ファイル内
...
Rei32Doc.h, Rei32Doc.cpp - ドキュメント
   これらのファイルは CRei32Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei32Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei32View.h, Rei32View.cpp - ドキュメントのビュー
   これらのファイルは CRei32View クラスを含みます。
   CRei32View オブジェクトは CRei32Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei32.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
