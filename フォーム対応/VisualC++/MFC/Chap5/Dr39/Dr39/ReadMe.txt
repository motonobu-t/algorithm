================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr39 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr39 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr39 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr39.h
   ...
   CDr39App アプリケーション クラスを宣言します。

Dr39.cpp
   これは、アプリケーション クラス CDr39App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr39.ico
   ...
   アイコンはメイン リソース ファイル Dr39.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr39.rc ファイル内
...
Dr39Doc.h, Dr39Doc.cpp - ドキュメント
   これらのファイルは CDr39Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr39Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr39View.h, Dr39View.cpp - ドキュメントのビュー
   これらのファイルは CDr39View クラスを含みます。
   CDr39View オブジェクトは CDr39Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr39.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
