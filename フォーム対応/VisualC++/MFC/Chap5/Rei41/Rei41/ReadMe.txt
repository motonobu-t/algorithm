================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei41 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei41 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei41 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei41.h
   ...
   CRei41App アプリケーション クラスを宣言します。

Rei41.cpp
   これは、アプリケーション クラス CRei41App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei41.ico
   ...
   アイコンはメイン リソース ファイル Rei41.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei41.rc ファイル内
...
Rei41Doc.h, Rei41Doc.cpp - ドキュメント
   これらのファイルは CRei41Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei41Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei41View.h, Rei41View.cpp - ドキュメントのビュー
   これらのファイルは CRei41View クラスを含みます。
   CRei41View オブジェクトは CRei41Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei41.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
