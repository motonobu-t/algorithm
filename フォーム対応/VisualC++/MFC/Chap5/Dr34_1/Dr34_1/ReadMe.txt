================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr34_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr34_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr34_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr34_1.h
   ...
   CDr34_1App アプリケーション クラスを宣言します。

Dr34_1.cpp
   これは、アプリケーション クラス CDr34_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr34_1.ico
   ...
   アイコンはメイン リソース ファイル Dr34_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr34_1.rc ファイル内
...
Dr34_1Doc.h, Dr34_1Doc.cpp - ドキュメント
   これらのファイルは CDr34_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr34_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr34_1View.h, Dr34_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr34_1View クラスを含みます。
   CDr34_1View オブジェクトは CDr34_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr34_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
