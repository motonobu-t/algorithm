================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr41 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr41 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr41 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr41.h
   ...
   CDr41App アプリケーション クラスを宣言します。

Dr41.cpp
   これは、アプリケーション クラス CDr41App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr41.ico
   ...
   アイコンはメイン リソース ファイル Dr41.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr41.rc ファイル内
...
Dr41Doc.h, Dr41Doc.cpp - ドキュメント
   これらのファイルは CDr41Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr41Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr41View.h, Dr41View.cpp - ドキュメントのビュー
   これらのファイルは CDr41View クラスを含みます。
   CDr41View オブジェクトは CDr41Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr41.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
