================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei33 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei33 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei33 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei33.h
   ...
   CRei33App アプリケーション クラスを宣言します。

Rei33.cpp
   これは、アプリケーション クラス CRei33App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei33.ico
   ...
   アイコンはメイン リソース ファイル Rei33.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei33.rc ファイル内
...
Rei33Doc.h, Rei33Doc.cpp - ドキュメント
   これらのファイルは CRei33Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei33Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei33View.h, Rei33View.cpp - ドキュメントのビュー
   これらのファイルは CRei33View クラスを含みます。
   CRei33View オブジェクトは CRei33Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei33.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
