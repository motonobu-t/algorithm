================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr38_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr38_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr38_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr38_1.h
   ...
   CDr38_1App アプリケーション クラスを宣言します。

Dr38_1.cpp
   これは、アプリケーション クラス CDr38_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr38_1.ico
   ...
   アイコンはメイン リソース ファイル Dr38_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr38_1.rc ファイル内
...
Dr38_1Doc.h, Dr38_1Doc.cpp - ドキュメント
   これらのファイルは CDr38_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr38_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr38_1View.h, Dr38_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr38_1View クラスを含みます。
   CDr38_1View オブジェクトは CDr38_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr38_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
