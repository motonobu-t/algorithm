================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei37 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei37 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei37 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei37.h
   ...
   CRei37App アプリケーション クラスを宣言します。

Rei37.cpp
   これは、アプリケーション クラス CRei37App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei37.ico
   ...
   アイコンはメイン リソース ファイル Rei37.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei37.rc ファイル内
...
Rei37Doc.h, Rei37Doc.cpp - ドキュメント
   これらのファイルは CRei37Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei37Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei37View.h, Rei37View.cpp - ドキュメントのビュー
   これらのファイルは CRei37View クラスを含みます。
   CRei37View オブジェクトは CRei37Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei37.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
