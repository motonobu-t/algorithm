================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei39 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei39 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei39 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei39.h
   ...
   CRei39App アプリケーション クラスを宣言します。

Rei39.cpp
   これは、アプリケーション クラス CRei39App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei39.ico
   ...
   アイコンはメイン リソース ファイル Rei39.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei39.rc ファイル内
...
Rei39Doc.h, Rei39Doc.cpp - ドキュメント
   これらのファイルは CRei39Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei39Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei39View.h, Rei39View.cpp - ドキュメントのビュー
   これらのファイルは CRei39View クラスを含みます。
   CRei39View オブジェクトは CRei39Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei39.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
