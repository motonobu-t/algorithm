================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr34_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr34_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr34_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr34_2.h
   ...
   CDr34_2App アプリケーション クラスを宣言します。

Dr34_2.cpp
   これは、アプリケーション クラス CDr34_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr34_2.ico
   ...
   アイコンはメイン リソース ファイル Dr34_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr34_2.rc ファイル内
...
Dr34_2Doc.h, Dr34_2Doc.cpp - ドキュメント
   これらのファイルは CDr34_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr34_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr34_2View.h, Dr34_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr34_2View クラスを含みます。
   CDr34_2View オブジェクトは CDr34_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr34_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
