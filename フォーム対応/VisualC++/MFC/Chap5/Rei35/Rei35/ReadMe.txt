================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei35 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei35 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei35 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei35.h
   ...
   CRei35App アプリケーション クラスを宣言します。

Rei35.cpp
   これは、アプリケーション クラス CRei35App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei35.ico
   ...
   アイコンはメイン リソース ファイル Rei35.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei35.rc ファイル内
...
Rei35Doc.h, Rei35Doc.cpp - ドキュメント
   これらのファイルは CRei35Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei35Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei35View.h, Rei35View.cpp - ドキュメントのビュー
   これらのファイルは CRei35View クラスを含みます。
   CRei35View オブジェクトは CRei35Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei35.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
