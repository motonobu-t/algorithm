================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei38 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei38 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei38 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei38.h
   ...
   CRei38App アプリケーション クラスを宣言します。

Rei38.cpp
   これは、アプリケーション クラス CRei38App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei38.ico
   ...
   アイコンはメイン リソース ファイル Rei38.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei38.rc ファイル内
...
Rei38Doc.h, Rei38Doc.cpp - ドキュメント
   これらのファイルは CRei38Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei38Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei38View.h, Rei38View.cpp - ドキュメントのビュー
   これらのファイルは CRei38View クラスを含みます。
   CRei38View オブジェクトは CRei38Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei38.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
