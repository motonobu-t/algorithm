================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr35_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr35_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr35_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr35_2.h
   ...
   CDr35_2App アプリケーション クラスを宣言します。

Dr35_2.cpp
   これは、アプリケーション クラス CDr35_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr35_2.ico
   ...
   アイコンはメイン リソース ファイル Dr35_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr35_2.rc ファイル内
...
Dr35_2Doc.h, Dr35_2Doc.cpp - ドキュメント
   これらのファイルは CDr35_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr35_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr35_2View.h, Dr35_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr35_2View クラスを含みます。
   CDr35_2View オブジェクトは CDr35_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr35_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
