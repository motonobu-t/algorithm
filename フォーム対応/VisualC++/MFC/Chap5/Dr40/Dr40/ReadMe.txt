================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr40 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr40 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr40 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr40.h
   ...
   CDr40App アプリケーション クラスを宣言します。

Dr40.cpp
   これは、アプリケーション クラス CDr40App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr40.ico
   ...
   アイコンはメイン リソース ファイル Dr40.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr40.rc ファイル内
...
Dr40Doc.h, Dr40Doc.cpp - ドキュメント
   これらのファイルは CDr40Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr40Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr40View.h, Dr40View.cpp - ドキュメントのビュー
   これらのファイルは CDr40View クラスを含みます。
   CDr40View オブジェクトは CDr40Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr40.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
