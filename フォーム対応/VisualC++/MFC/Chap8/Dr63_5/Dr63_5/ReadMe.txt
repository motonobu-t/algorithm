================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr63_5 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr63_5 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr63_5 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr63_5.h
   ...
   CDr63_5App アプリケーション クラスを宣言します。

Dr63_5.cpp
   これは、アプリケーション クラス CDr63_5App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr63_5.ico
   ...
   アイコンはメイン リソース ファイル Dr63_5.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr63_5.rc ファイル内
...
Dr63_5Doc.h, Dr63_5Doc.cpp - ドキュメント
   これらのファイルは CDr63_5Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr63_5Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr63_5View.h, Dr63_5View.cpp - ドキュメントのビュー
   これらのファイルは CDr63_5View クラスを含みます。
   CDr63_5View オブジェクトは CDr63_5Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr63_5.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
