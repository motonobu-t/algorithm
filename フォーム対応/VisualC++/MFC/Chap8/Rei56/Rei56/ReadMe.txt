================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei56 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei56 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei56 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei56.h
   ...
   CRei56App アプリケーション クラスを宣言します。

Rei56.cpp
   これは、アプリケーション クラス CRei56App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei56.ico
   ...
   アイコンはメイン リソース ファイル Rei56.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei56.rc ファイル内
...
Rei56Doc.h, Rei56Doc.cpp - ドキュメント
   これらのファイルは CRei56Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei56Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei56View.h, Rei56View.cpp - ドキュメントのビュー
   これらのファイルは CRei56View クラスを含みます。
   CRei56View オブジェクトは CRei56Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei56.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
