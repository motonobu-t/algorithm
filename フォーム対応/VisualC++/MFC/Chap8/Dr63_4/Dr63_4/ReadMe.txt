================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr63_4 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr63_4 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr63_4 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr63_4.h
   ...
   CDr63_4App アプリケーション クラスを宣言します。

Dr63_4.cpp
   これは、アプリケーション クラス CDr63_4App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr63_4.ico
   ...
   アイコンはメイン リソース ファイル Dr63_4.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr63_4.rc ファイル内
...
Dr63_4Doc.h, Dr63_4Doc.cpp - ドキュメント
   これらのファイルは CDr63_4Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr63_4Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr63_4View.h, Dr63_4View.cpp - ドキュメントのビュー
   これらのファイルは CDr63_4View クラスを含みます。
   CDr63_4View オブジェクトは CDr63_4Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr63_4.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
