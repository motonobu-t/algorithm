================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr62_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr62_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr62_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr62_1.h
   ...
   CDr62_1App アプリケーション クラスを宣言します。

Dr62_1.cpp
   これは、アプリケーション クラス CDr62_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr62_1.ico
   ...
   アイコンはメイン リソース ファイル Dr62_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr62_1.rc ファイル内
...
Dr62_1Doc.h, Dr62_1Doc.cpp - ドキュメント
   これらのファイルは CDr62_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr62_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr62_1View.h, Dr62_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr62_1View クラスを含みます。
   CDr62_1View オブジェクトは CDr62_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr62_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
