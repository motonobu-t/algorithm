================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei60 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei60 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei60 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei60.h
   ...
   CRei60App アプリケーション クラスを宣言します。

Rei60.cpp
   これは、アプリケーション クラス CRei60App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei60.ico
   ...
   アイコンはメイン リソース ファイル Rei60.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei60.rc ファイル内
...
Rei60Doc.h, Rei60Doc.cpp - ドキュメント
   これらのファイルは CRei60Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei60Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei60View.h, Rei60View.cpp - ドキュメントのビュー
   これらのファイルは CRei60View クラスを含みます。
   CRei60View オブジェクトは CRei60Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei60.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
