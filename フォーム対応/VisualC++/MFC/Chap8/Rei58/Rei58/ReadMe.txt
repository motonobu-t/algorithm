================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei58 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei58 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei58 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei58.h
   ...
   CRei58App アプリケーション クラスを宣言します。

Rei58.cpp
   これは、アプリケーション クラス CRei58App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei58.ico
   ...
   アイコンはメイン リソース ファイル Rei58.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei58.rc ファイル内
...
Rei58Doc.h, Rei58Doc.cpp - ドキュメント
   これらのファイルは CRei58Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei58Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei58View.h, Rei58View.cpp - ドキュメントのビュー
   これらのファイルは CRei58View クラスを含みます。
   CRei58View オブジェクトは CRei58Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei58.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
