================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr53 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr53 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr53 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr53.h
   ...
   CDr53App アプリケーション クラスを宣言します。

Dr53.cpp
   これは、アプリケーション クラス CDr53App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr53.ico
   ...
   アイコンはメイン リソース ファイル Dr53.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr53.rc ファイル内
...
Dr53Doc.h, Dr53Doc.cpp - ドキュメント
   これらのファイルは CDr53Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr53Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr53View.h, Dr53View.cpp - ドキュメントのビュー
   これらのファイルは CDr53View クラスを含みます。
   CDr53View オブジェクトは CDr53Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr53.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
