================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr52 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr52 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr52 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr52.h
   ...
   CDr52App アプリケーション クラスを宣言します。

Dr52.cpp
   これは、アプリケーション クラス CDr52App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr52.ico
   ...
   アイコンはメイン リソース ファイル Dr52.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr52.rc ファイル内
...
Dr52Doc.h, Dr52Doc.cpp - ドキュメント
   これらのファイルは CDr52Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr52Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr52View.h, Dr52View.cpp - ドキュメントのビュー
   これらのファイルは CDr52View クラスを含みます。
   CDr52View オブジェクトは CDr52Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr52.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
