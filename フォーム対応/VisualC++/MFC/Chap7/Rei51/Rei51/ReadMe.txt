================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei51 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei51 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei51 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei51.h
   ...
   CRei51App アプリケーション クラスを宣言します。

Rei51.cpp
   これは、アプリケーション クラス CRei51App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei51.ico
   ...
   アイコンはメイン リソース ファイル Rei51.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei51.rc ファイル内
...
Rei51Doc.h, Rei51Doc.cpp - ドキュメント
   これらのファイルは CRei51Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei51Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei51View.h, Rei51View.cpp - ドキュメントのビュー
   これらのファイルは CRei51View クラスを含みます。
   CRei51View オブジェクトは CRei51Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei51.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
