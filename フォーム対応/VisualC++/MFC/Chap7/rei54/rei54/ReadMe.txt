================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: rei54 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した rei54 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには rei54 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
rei54.h
   ...
   Crei54App アプリケーション クラスを宣言します。

rei54.cpp
   これは、アプリケーション クラス Crei54App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\rei54.ico
   ...
   アイコンはメイン リソース ファイル rei54.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、rei54.rc ファイル内
...
rei54Doc.h, rei54Doc.cpp - ドキュメント
   これらのファイルは Crei54Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via Crei54Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

rei54View.h, rei54View.cpp - ドキュメントのビュー
   これらのファイルは Crei54View クラスを含みます。
   Crei54View オブジェクトは Crei54Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   rei54.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
