================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr51_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr51_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr51_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr51_2.h
   ...
   CDr51_2App アプリケーション クラスを宣言します。

Dr51_2.cpp
   これは、アプリケーション クラス CDr51_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr51_2.ico
   ...
   アイコンはメイン リソース ファイル Dr51_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr51_2.rc ファイル内
...
Dr51_2Doc.h, Dr51_2Doc.cpp - ドキュメント
   これらのファイルは CDr51_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr51_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr51_2View.h, Dr51_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr51_2View クラスを含みます。
   CDr51_2View オブジェクトは CDr51_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr51_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
