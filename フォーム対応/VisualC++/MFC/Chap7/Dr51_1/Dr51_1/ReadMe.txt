================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr51_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr51_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr51_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr51_1.h
   ...
   CDr51_1App アプリケーション クラスを宣言します。

Dr51_1.cpp
   これは、アプリケーション クラス CDr51_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr51_1.ico
   ...
   アイコンはメイン リソース ファイル Dr51_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr51_1.rc ファイル内
...
Dr51_1Doc.h, Dr51_1Doc.cpp - ドキュメント
   これらのファイルは CDr51_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr51_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr51_1View.h, Dr51_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr51_1View クラスを含みます。
   CDr51_1View オブジェクトは CDr51_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr51_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
