================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei53 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei53 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei53 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei53.h
   ...
   CRei53App アプリケーション クラスを宣言します。

Rei53.cpp
   これは、アプリケーション クラス CRei53App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei53.ico
   ...
   アイコンはメイン リソース ファイル Rei53.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei53.rc ファイル内
...
Rei53Doc.h, Rei53Doc.cpp - ドキュメント
   これらのファイルは CRei53Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei53Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei53View.h, Rei53View.cpp - ドキュメントのビュー
   これらのファイルは CRei53View クラスを含みます。
   CRei53View オブジェクトは CRei53Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei53.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
