================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei55 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei55 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei55 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei55.h
   ...
   CRei55App アプリケーション クラスを宣言します。

Rei55.cpp
   これは、アプリケーション クラス CRei55App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei55.ico
   ...
   アイコンはメイン リソース ファイル Rei55.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei55.rc ファイル内
...
Rei55Doc.h, Rei55Doc.cpp - ドキュメント
   これらのファイルは CRei55Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei55Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei55View.h, Rei55View.cpp - ドキュメントのビュー
   これらのファイルは CRei55View クラスを含みます。
   CRei55View オブジェクトは CRei55Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei55.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
