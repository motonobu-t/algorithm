================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr25 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr25 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr25 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr25.h
   ...
   CDr25App アプリケーション クラスを宣言します。

Dr25.cpp
   これは、アプリケーション クラス CDr25App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr25.ico
   ...
   アイコンはメイン リソース ファイル Dr25.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr25.rc ファイル内
...
Dr25Doc.h, Dr25Doc.cpp - ドキュメント
   これらのファイルは CDr25Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr25Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr25View.h, Dr25View.cpp - ドキュメントのビュー
   これらのファイルは CDr25View クラスを含みます。
   CDr25View オブジェクトは CDr25Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr25.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
