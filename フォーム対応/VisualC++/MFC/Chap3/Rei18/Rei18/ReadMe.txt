================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei18 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei18 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei18 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei18.h
   ...
   CRei18App アプリケーション クラスを宣言します。

Rei18.cpp
   これは、アプリケーション クラス CRei18App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei18.ico
   ...
   アイコンはメイン リソース ファイル Rei18.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei18.rc ファイル内
...
Rei18Doc.h, Rei18Doc.cpp - ドキュメント
   これらのファイルは CRei18Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei18Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei18View.h, Rei18View.cpp - ドキュメントのビュー
   これらのファイルは CRei18View クラスを含みます。
   CRei18View オブジェクトは CRei18Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei18.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
