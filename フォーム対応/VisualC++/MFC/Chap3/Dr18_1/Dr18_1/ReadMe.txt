================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr18_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr18_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr18_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr18_1.h
   ...
   CDr18_1App アプリケーション クラスを宣言します。

Dr18_1.cpp
   これは、アプリケーション クラス CDr18_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr18_1.ico
   ...
   アイコンはメイン リソース ファイル Dr18_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr18_1.rc ファイル内
...
Dr18_1Doc.h, Dr18_1Doc.cpp - ドキュメント
   これらのファイルは CDr18_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr18_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr18_1View.h, Dr18_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr18_1View クラスを含みます。
   CDr18_1View オブジェクトは CDr18_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr18_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
