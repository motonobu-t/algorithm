================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr21 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr21 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr21 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr21.h
   ...
   CDr21App アプリケーション クラスを宣言します。

Dr21.cpp
   これは、アプリケーション クラス CDr21App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr21.ico
   ...
   アイコンはメイン リソース ファイル Dr21.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr21.rc ファイル内
...
Dr21Doc.h, Dr21Doc.cpp - ドキュメント
   これらのファイルは CDr21Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr21Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr21View.h, Dr21View.cpp - ドキュメントのビュー
   これらのファイルは CDr21View クラスを含みます。
   CDr21View オブジェクトは CDr21Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr21.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
