================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr24 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr24 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr24 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr24.h
   ...
   CDr24App アプリケーション クラスを宣言します。

Dr24.cpp
   これは、アプリケーション クラス CDr24App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr24.ico
   ...
   アイコンはメイン リソース ファイル Dr24.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr24.rc ファイル内
...
Dr24Doc.h, Dr24Doc.cpp - ドキュメント
   これらのファイルは CDr24Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr24Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr24View.h, Dr24View.cpp - ドキュメントのビュー
   これらのファイルは CDr24View クラスを含みます。
   CDr24View オブジェクトは CDr24Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr24.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
