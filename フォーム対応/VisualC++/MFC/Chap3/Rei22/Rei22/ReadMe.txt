================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei22 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei22 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei22 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei22.h
   ...
   CRei22App アプリケーション クラスを宣言します。

Rei22.cpp
   これは、アプリケーション クラス CRei22App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei22.ico
   ...
   アイコンはメイン リソース ファイル Rei22.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei22.rc ファイル内
...
Rei22Doc.h, Rei22Doc.cpp - ドキュメント
   これらのファイルは CRei22Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei22Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei22View.h, Rei22View.cpp - ドキュメントのビュー
   これらのファイルは CRei22View クラスを含みます。
   CRei22View オブジェクトは CRei22Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei22.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
