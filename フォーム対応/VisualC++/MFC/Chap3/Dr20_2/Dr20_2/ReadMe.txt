================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr20_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr20_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr20_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr20_2.h
   ...
   CDr20_2App アプリケーション クラスを宣言します。

Dr20_2.cpp
   これは、アプリケーション クラス CDr20_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr20_2.ico
   ...
   アイコンはメイン リソース ファイル Dr20_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr20_2.rc ファイル内
...
Dr20_2Doc.h, Dr20_2Doc.cpp - ドキュメント
   これらのファイルは CDr20_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr20_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr20_2View.h, Dr20_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr20_2View クラスを含みます。
   CDr20_2View オブジェクトは CDr20_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr20_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
