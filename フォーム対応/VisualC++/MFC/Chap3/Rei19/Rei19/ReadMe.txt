================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei19 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei19 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei19 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei19.h
   ...
   CRei19App アプリケーション クラスを宣言します。

Rei19.cpp
   これは、アプリケーション クラス CRei19App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei19.ico
   ...
   アイコンはメイン リソース ファイル Rei19.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei19.rc ファイル内
...
Rei19Doc.h, Rei19Doc.cpp - ドキュメント
   これらのファイルは CRei19Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei19Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei19View.h, Rei19View.cpp - ドキュメントのビュー
   これらのファイルは CRei19View クラスを含みます。
   CRei19View オブジェクトは CRei19Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei19.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
