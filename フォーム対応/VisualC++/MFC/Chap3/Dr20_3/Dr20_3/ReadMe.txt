================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr20_3 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr20_3 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr20_3 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr20_3.h
   ...
   CDr20_3App アプリケーション クラスを宣言します。

Dr20_3.cpp
   これは、アプリケーション クラス CDr20_3App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr20_3.ico
   ...
   アイコンはメイン リソース ファイル Dr20_3.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr20_3.rc ファイル内
...
Dr20_3Doc.h, Dr20_3Doc.cpp - ドキュメント
   これらのファイルは CDr20_3Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr20_3Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr20_3View.h, Dr20_3View.cpp - ドキュメントのビュー
   これらのファイルは CDr20_3View クラスを含みます。
   CDr20_3View オブジェクトは CDr20_3Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr20_3.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
