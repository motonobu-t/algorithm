================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr19_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr19_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr19_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr19_2.h
   ...
   CDr19_2App アプリケーション クラスを宣言します。

Dr19_2.cpp
   これは、アプリケーション クラス CDr19_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr19_2.ico
   ...
   アイコンはメイン リソース ファイル Dr19_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr19_2.rc ファイル内
...
Dr19_2Doc.h, Dr19_2Doc.cpp - ドキュメント
   これらのファイルは CDr19_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr19_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr19_2View.h, Dr19_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr19_2View クラスを含みます。
   CDr19_2View オブジェクトは CDr19_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr19_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
