================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei20 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei20 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei20 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei20.h
   ...
   CRei20App アプリケーション クラスを宣言します。

Rei20.cpp
   これは、アプリケーション クラス CRei20App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei20.ico
   ...
   アイコンはメイン リソース ファイル Rei20.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei20.rc ファイル内
...
Rei20Doc.h, Rei20Doc.cpp - ドキュメント
   これらのファイルは CRei20Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei20Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei20View.h, Rei20View.cpp - ドキュメントのビュー
   これらのファイルは CRei20View クラスを含みます。
   CRei20View オブジェクトは CRei20Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei20.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
