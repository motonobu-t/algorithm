================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei25 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei25 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei25 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei25.h
   ...
   CRei25App アプリケーション クラスを宣言します。

Rei25.cpp
   これは、アプリケーション クラス CRei25App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei25.ico
   ...
   アイコンはメイン リソース ファイル Rei25.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei25.rc ファイル内
...
Rei25Doc.h, Rei25Doc.cpp - ドキュメント
   これらのファイルは CRei25Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei25Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei25View.h, Rei25View.cpp - ドキュメントのビュー
   これらのファイルは CRei25View クラスを含みます。
   CRei25View オブジェクトは CRei25Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei25.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
