================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr19_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr19_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr19_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr19_1.h
   ...
   CDr19_1App アプリケーション クラスを宣言します。

Dr19_1.cpp
   これは、アプリケーション クラス CDr19_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr19_1.ico
   ...
   アイコンはメイン リソース ファイル Dr19_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr19_1.rc ファイル内
...
Dr19_1Doc.h, Dr19_1Doc.cpp - ドキュメント
   これらのファイルは CDr19_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr19_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr19_1View.h, Dr19_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr19_1View クラスを含みます。
   CDr19_1View オブジェクトは CDr19_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr19_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
