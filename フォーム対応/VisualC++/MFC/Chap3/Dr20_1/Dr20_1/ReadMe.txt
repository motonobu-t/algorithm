================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr20_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr20_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr20_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr20_1.h
   ...
   CDr20_1App アプリケーション クラスを宣言します。

Dr20_1.cpp
   これは、アプリケーション クラス CDr20_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr20_1.ico
   ...
   アイコンはメイン リソース ファイル Dr20_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr20_1.rc ファイル内
...
Dr20_1Doc.h, Dr20_1Doc.cpp - ドキュメント
   これらのファイルは CDr20_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr20_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr20_1View.h, Dr20_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr20_1View クラスを含みます。
   CDr20_1View オブジェクトは CDr20_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr20_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
