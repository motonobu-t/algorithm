================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei21 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei21 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei21 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei21.h
   ...
   CRei21App アプリケーション クラスを宣言します。

Rei21.cpp
   これは、アプリケーション クラス CRei21App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei21.ico
   ...
   アイコンはメイン リソース ファイル Rei21.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei21.rc ファイル内
...
Rei21Doc.h, Rei21Doc.cpp - ドキュメント
   これらのファイルは CRei21Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei21Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei21View.h, Rei21View.cpp - ドキュメントのビュー
   これらのファイルは CRei21View クラスを含みます。
   CRei21View オブジェクトは CRei21Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei21.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
