================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr18_3 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr18_3 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr18_3 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr18_3.h
   ...
   CDr18_3App アプリケーション クラスを宣言します。

Dr18_3.cpp
   これは、アプリケーション クラス CDr18_3App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr18_3.ico
   ...
   アイコンはメイン リソース ファイル Dr18_3.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr18_3.rc ファイル内
...
Dr18_3Doc.h, Dr18_3Doc.cpp - ドキュメント
   これらのファイルは CDr18_3Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr18_3Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr18_3View.h, Dr18_3View.cpp - ドキュメントのビュー
   これらのファイルは CDr18_3View クラスを含みます。
   CDr18_3View オブジェクトは CDr18_3Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr18_3.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
