================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr18_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr18_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr18_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr18_2.h
   ...
   CDr18_2App アプリケーション クラスを宣言します。

Dr18_2.cpp
   これは、アプリケーション クラス CDr18_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr18_2.ico
   ...
   アイコンはメイン リソース ファイル Dr18_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr18_2.rc ファイル内
...
Dr18_2Doc.h, Dr18_2Doc.cpp - ドキュメント
   これらのファイルは CDr18_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr18_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr18_2View.h, Dr18_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr18_2View クラスを含みます。
   CDr18_2View オブジェクトは CDr18_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr18_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
