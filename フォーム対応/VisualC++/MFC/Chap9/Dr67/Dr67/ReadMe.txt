================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr67 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr67 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr67 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr67.h
   ...
   CDr67App アプリケーション クラスを宣言します。

Dr67.cpp
   これは、アプリケーション クラス CDr67App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr67.ico
   ...
   アイコンはメイン リソース ファイル Dr67.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr67.rc ファイル内
...
Dr67Doc.h, Dr67Doc.cpp - ドキュメント
   これらのファイルは CDr67Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr67Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr67View.h, Dr67View.cpp - ドキュメントのビュー
   これらのファイルは CDr67View クラスを含みます。
   CDr67View オブジェクトは CDr67Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr67.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
