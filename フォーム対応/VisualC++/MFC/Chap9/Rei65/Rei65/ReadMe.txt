================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei65 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei65 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei65 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei65.h
   ...
   CRei65App アプリケーション クラスを宣言します。

Rei65.cpp
   これは、アプリケーション クラス CRei65App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei65.ico
   ...
   アイコンはメイン リソース ファイル Rei65.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei65.rc ファイル内
...
Rei65Doc.h, Rei65Doc.cpp - ドキュメント
   これらのファイルは CRei65Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei65Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei65View.h, Rei65View.cpp - ドキュメントのビュー
   これらのファイルは CRei65View クラスを含みます。
   CRei65View オブジェクトは CRei65Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei65.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
