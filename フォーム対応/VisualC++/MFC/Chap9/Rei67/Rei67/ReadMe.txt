================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei67 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei67 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei67 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei67.h
   ...
   CRei67App アプリケーション クラスを宣言します。

Rei67.cpp
   これは、アプリケーション クラス CRei67App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei67.ico
   ...
   アイコンはメイン リソース ファイル Rei67.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei67.rc ファイル内
...
Rei67Doc.h, Rei67Doc.cpp - ドキュメント
   これらのファイルは CRei67Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei67Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei67View.h, Rei67View.cpp - ドキュメントのビュー
   これらのファイルは CRei67View クラスを含みます。
   CRei67View オブジェクトは CRei67Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei67.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
