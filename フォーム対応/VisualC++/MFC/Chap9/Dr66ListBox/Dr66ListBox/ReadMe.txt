================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr66ListBox プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr66ListBox には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr66ListBox アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr66ListBox.h
   ...
   CDr66ListBoxApp アプリケーション クラスを宣言します。

Dr66ListBox.cpp
   これは、アプリケーション クラス CDr66ListBoxApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr66ListBox.ico
   ...
   アイコンはメイン リソース ファイル Dr66ListBox.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr66ListBox.rc ファイル内
...
Dr66ListBoxDoc.h, Dr66ListBoxDoc.cpp - ドキュメント
   これらのファイルは CDr66ListBoxDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr66ListBoxDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr66ListBoxView.h, Dr66ListBoxView.cpp - ドキュメントのビュー
   これらのファイルは CDr66ListBoxView クラスを含みます。
   CDr66ListBoxView オブジェクトは CDr66ListBoxDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr66ListBox.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
