================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei66ListBox プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei66ListBox には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei66ListBox アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei66ListBox.h
   ...
   CRei66ListBoxApp アプリケーション クラスを宣言します。

Rei66ListBox.cpp
   これは、アプリケーション クラス CRei66ListBoxApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei66ListBox.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル Rei66ListBox.rc に含まれていま
   す。

res\Rei66ListBox.rc2
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei66ListBox.rc ファイル内
...
Rei66ListBoxDoc.h, Rei66ListBoxDoc.cpp - ドキュメント
   これらのファイルは CRei66ListBoxDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei66ListBoxDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei66ListBoxView.h, Rei66ListBoxView.cpp - ドキュメントのビュー
   これらのファイルは CRei66ListBoxView クラスを含みます。
   CRei66ListBoxView オブジェクトは CRei66ListBoxDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei66ListBox.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
