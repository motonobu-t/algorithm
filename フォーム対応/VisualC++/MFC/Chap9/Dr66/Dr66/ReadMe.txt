================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr66 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr66 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr66 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr66.h
   ...
   CDr66App アプリケーション クラスを宣言します。

Dr66.cpp
   これは、アプリケーション クラス CDr66App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr66.ico
   ...
   アイコンはメイン リソース ファイル Dr66.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr66.rc ファイル内
...
Dr66Doc.h, Dr66Doc.cpp - ドキュメント
   これらのファイルは CDr66Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr66Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr66View.h, Dr66View.cpp - ドキュメントのビュー
   これらのファイルは CDr66View クラスを含みます。
   CDr66View オブジェクトは CDr66Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr66.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
