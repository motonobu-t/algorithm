================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei5 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei5 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei5 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei5.h
   ...
   CRei5App アプリケーション クラスを宣言します。

Rei5.cpp
   これは、アプリケーション クラス CRei5App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei5.ico
   ...
   アイコンはメイン リソース ファイル Rei5.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei5.rc ファイル内
...
Rei5Doc.h, Rei5Doc.cpp - ドキュメント
   これらのファイルは CRei5Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei5Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei5View.h, Rei5View.cpp - ドキュメントのビュー
   これらのファイルは CRei5View クラスを含みます。
   CRei5View オブジェクトは CRei5Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei5.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
