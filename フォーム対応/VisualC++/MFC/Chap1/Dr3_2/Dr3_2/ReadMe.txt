================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr3_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr3_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr3_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr3_2.h
   ...
   CDr3_2App アプリケーション クラスを宣言します。

Dr3_2.cpp
   これは、アプリケーション クラス CDr3_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr3_2.ico
   ...
   アイコンはメイン リソース ファイル Dr3_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr3_2.rc ファイル内
...
Dr3_2Doc.h, Dr3_2Doc.cpp - ドキュメント
   これらのファイルは CDr3_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr3_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr3_2View.h, Dr3_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr3_2View クラスを含みます。
   CDr3_2View オブジェクトは CDr3_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr3_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
