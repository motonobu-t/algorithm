================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr1_2Label プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr1_2Label には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr1_2Label アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr1_2Label.h
   ...
   CDr1_2LabelApp アプリケーション クラスを宣言します。

Dr1_2Label.cpp
   これは、アプリケーション クラス CDr1_2LabelApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr1_2Label.ico
   ...
   アイコンはメイン リソース ファイル Dr1_2Label.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr1_2Label.rc ファイル内
...
Dr1_2LabelDoc.h, Dr1_2LabelDoc.cpp - ドキュメント
   これらのファイルは CDr1_2LabelDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr1_2LabelDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr1_2LabelView.h, Dr1_2LabelView.cpp - ドキュメントのビュー
   これらのファイルは CDr1_2LabelView クラスを含みます。
   CDr1_2LabelView オブジェクトは CDr1_2LabelDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr1_2Label.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
