================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr3_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr3_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr3_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr3_1.h
   ...
   CDr3_1App アプリケーション クラスを宣言します。

Dr3_1.cpp
   これは、アプリケーション クラス CDr3_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr3_1.ico
   ...
   アイコンはメイン リソース ファイル Dr3_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr3_1.rc ファイル内
...
Dr3_1Doc.h, Dr3_1Doc.cpp - ドキュメント
   これらのファイルは CDr3_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr3_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr3_1View.h, Dr3_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr3_1View クラスを含みます。
   CDr3_1View オブジェクトは CDr3_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr3_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
