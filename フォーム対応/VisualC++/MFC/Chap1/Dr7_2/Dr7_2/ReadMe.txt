================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr7_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr7_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr7_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr7_2.h
   ...
   CDr7_2App アプリケーション クラスを宣言します。

Dr7_2.cpp
   これは、アプリケーション クラス CDr7_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr7_2.ico
   ...
   アイコンはメイン リソース ファイル Dr7_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr7_2.rc ファイル内
...
Dr7_2Doc.h, Dr7_2Doc.cpp - ドキュメント
   これらのファイルは CDr7_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr7_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr7_2View.h, Dr7_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr7_2View クラスを含みます。
   CDr7_2View オブジェクトは CDr7_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr7_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
