================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr1_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr1_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr1_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr1_1.h
   ...
   CDr1_1App アプリケーション クラスを宣言します。

Dr1_1.cpp
   これは、アプリケーション クラス CDr1_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr1_1.ico
   ...
   アイコンはメイン リソース ファイル Dr1_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr1_1.rc ファイル内
...
Dr1_1Doc.h, Dr1_1Doc.cpp - ドキュメント
   これらのファイルは CDr1_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr1_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr1_1View.h, Dr1_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr1_1View クラスを含みます。
   CDr1_1View オブジェクトは CDr1_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr1_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
