================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei1.h
   ...
   CRei1App アプリケーション クラスを宣言します。

Rei1.cpp
   これは、アプリケーション クラス CRei1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei1.ico
   ...
   アイコンはメイン リソース ファイル Rei1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei1.rc ファイル内
...
Rei1Doc.h, Rei1Doc.cpp - ドキュメント
   これらのファイルは CRei1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei1View.h, Rei1View.cpp - ドキュメントのビュー
   これらのファイルは CRei1View クラスを含みます。
   CRei1View オブジェクトは CRei1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
