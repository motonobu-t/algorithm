================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei3 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei3 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei3 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei3.h
   ...
   CRei3App アプリケーション クラスを宣言します。

Rei3.cpp
   これは、アプリケーション クラス CRei3App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei3.ico
   ...
   アイコンはメイン リソース ファイル Rei3.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei3.rc ファイル内
...
Rei3Doc.h, Rei3Doc.cpp - ドキュメント
   これらのファイルは CRei3Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei3Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei3View.h, Rei3View.cpp - ドキュメントのビュー
   これらのファイルは CRei3View クラスを含みます。
   CRei3View オブジェクトは CRei3Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei3.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
