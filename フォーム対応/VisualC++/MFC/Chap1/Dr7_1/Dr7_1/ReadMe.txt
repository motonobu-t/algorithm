================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr7_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr7_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr7_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr7_1.h
   ...
   CDr7_1App アプリケーション クラスを宣言します。

Dr7_1.cpp
   これは、アプリケーション クラス CDr7_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr7_1.ico
   ...
   アイコンはメイン リソース ファイル Dr7_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr7_1.rc ファイル内
...
Dr7_1Doc.h, Dr7_1Doc.cpp - ドキュメント
   これらのファイルは CDr7_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr7_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr7_1View.h, Dr7_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr7_1View クラスを含みます。
   CDr7_1View オブジェクトは CDr7_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr7_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
