================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr1_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr1_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr1_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr1_2.h
   ...
   CDr1_2App アプリケーション クラスを宣言します。

Dr1_2.cpp
   これは、アプリケーション クラス CDr1_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr1_2.ico
   ...
   アイコンはメイン リソース ファイル Dr1_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr1_2.rc ファイル内
...
Dr1_2Doc.h, Dr1_2Doc.cpp - ドキュメント
   これらのファイルは CDr1_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr1_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr1_2View.h, Dr1_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr1_2View クラスを含みます。
   CDr1_2View オブジェクトは CDr1_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr1_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
