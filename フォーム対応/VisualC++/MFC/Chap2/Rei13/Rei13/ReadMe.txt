================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei13 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei13 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei13 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei13.h
   ...
   CRei13App アプリケーション クラスを宣言します。

Rei13.cpp
   これは、アプリケーション クラス CRei13App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei13.ico
   ...
   アイコンはメイン リソース ファイル Rei13.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei13.rc ファイル内
...
Rei13Doc.h, Rei13Doc.cpp - ドキュメント
   これらのファイルは CRei13Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei13Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei13View.h, Rei13View.cpp - ドキュメントのビュー
   これらのファイルは CRei13View クラスを含みます。
   CRei13View オブジェクトは CRei13Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei13.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
