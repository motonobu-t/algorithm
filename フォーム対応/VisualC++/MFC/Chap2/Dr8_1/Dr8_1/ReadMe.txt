================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr8_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr8_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr8_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr8_1.h
   ...
   CDr8_1App アプリケーション クラスを宣言します。

Dr8_1.cpp
   これは、アプリケーション クラス CDr8_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr8_1.ico
   ...
   アイコンはメイン リソース ファイル Dr8_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr8_1.rc ファイル内
...
Dr8_1Doc.h, Dr8_1Doc.cpp - ドキュメント
   これらのファイルは CDr8_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr8_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr8_1View.h, Dr8_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr8_1View クラスを含みます。
   CDr8_1View オブジェクトは CDr8_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr8_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
