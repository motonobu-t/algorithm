================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr14_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr14_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr14_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr14_1.h
   ...
   CDr14_1App アプリケーション クラスを宣言します。

Dr14_1.cpp
   これは、アプリケーション クラス CDr14_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr14_1.ico
   ...
   アイコンはメイン リソース ファイル Dr14_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr14_1.rc ファイル内
...
Dr14_1Doc.h, Dr14_1Doc.cpp - ドキュメント
   これらのファイルは CDr14_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr14_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr14_1View.h, Dr14_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr14_1View クラスを含みます。
   CDr14_1View オブジェクトは CDr14_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr14_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
