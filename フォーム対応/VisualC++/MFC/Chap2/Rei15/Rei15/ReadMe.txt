================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei15 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei15 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei15 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei15.h
   ...
   CRei15App アプリケーション クラスを宣言します。

Rei15.cpp
   これは、アプリケーション クラス CRei15App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei15.ico
   ...
   アイコンはメイン リソース ファイル Rei15.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei15.rc ファイル内
...
Rei15Doc.h, Rei15Doc.cpp - ドキュメント
   これらのファイルは CRei15Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei15Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei15View.h, Rei15View.cpp - ドキュメントのビュー
   これらのファイルは CRei15View クラスを含みます。
   CRei15View オブジェクトは CRei15Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei15.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
