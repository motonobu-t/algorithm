================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei12 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei12 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei12 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei12.h
   ...
   CRei12App アプリケーション クラスを宣言します。

Rei12.cpp
   これは、アプリケーション クラス CRei12App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei12.ico
   ...
   アイコンはメイン リソース ファイル Rei12.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei12.rc ファイル内
...
Rei12Doc.h, Rei12Doc.cpp - ドキュメント
   これらのファイルは CRei12Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei12Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei12View.h, Rei12View.cpp - ドキュメントのビュー
   これらのファイルは CRei12View クラスを含みます。
   CRei12View オブジェクトは CRei12Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei12.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
