================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei8 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei8 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei8 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei8.h
   ...
   CRei8App アプリケーション クラスを宣言します。

Rei8.cpp
   これは、アプリケーション クラス CRei8App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei8.ico
   ...
   アイコンはメイン リソース ファイル Rei8.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei8.rc ファイル内
...
Rei8Doc.h, Rei8Doc.cpp - ドキュメント
   これらのファイルは CRei8Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei8Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei8View.h, Rei8View.cpp - ドキュメントのビュー
   これらのファイルは CRei8View クラスを含みます。
   CRei8View オブジェクトは CRei8Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei8.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
