================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr15_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr15_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr15_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr15_1.h
   ...
   CDr15_1App アプリケーション クラスを宣言します。

Dr15_1.cpp
   これは、アプリケーション クラス CDr15_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr15_1.ico
   ...
   アイコンはメイン リソース ファイル Dr15_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr15_1.rc ファイル内
...
Dr15_1Doc.h, Dr15_1Doc.cpp - ドキュメント
   これらのファイルは CDr15_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr15_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr15_1View.h, Dr15_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr15_1View クラスを含みます。
   CDr15_1View オブジェクトは CDr15_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr15_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
