================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei17 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei17 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei17 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei17.h
   ...
   CRei17App アプリケーション クラスを宣言します。

Rei17.cpp
   これは、アプリケーション クラス CRei17App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei17.ico
   ...
   アイコンはメイン リソース ファイル Rei17.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei17.rc ファイル内
...
Rei17Doc.h, Rei17Doc.cpp - ドキュメント
   これらのファイルは CRei17Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei17Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei17View.h, Rei17View.cpp - ドキュメントのビュー
   これらのファイルは CRei17View クラスを含みます。
   CRei17View オブジェクトは CRei17Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei17.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
