================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei16 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei16 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei16 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei16.h
   ...
   CRei16App アプリケーション クラスを宣言します。

Rei16.cpp
   これは、アプリケーション クラス CRei16App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei16.ico
   ...
   アイコンはメイン リソース ファイル Rei16.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei16.rc ファイル内
...
Rei16Doc.h, Rei16Doc.cpp - ドキュメント
   これらのファイルは CRei16Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei16Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei16View.h, Rei16View.cpp - ドキュメントのビュー
   これらのファイルは CRei16View クラスを含みます。
   CRei16View オブジェクトは CRei16Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei16.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
