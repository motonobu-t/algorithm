================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei10 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei10 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei10 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei10.h
   ...
   CRei10App アプリケーション クラスを宣言します。

Rei10.cpp
   これは、アプリケーション クラス CRei10App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei10.ico
   ...
   アイコンはメイン リソース ファイル Rei10.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei10.rc ファイル内
...
Rei10Doc.h, Rei10Doc.cpp - ドキュメント
   これらのファイルは CRei10Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei10Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei10View.h, Rei10View.cpp - ドキュメントのビュー
   これらのファイルは CRei10View クラスを含みます。
   CRei10View オブジェクトは CRei10Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei10.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
