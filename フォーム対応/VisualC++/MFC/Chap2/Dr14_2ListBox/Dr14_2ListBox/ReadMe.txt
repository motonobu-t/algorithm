================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr14_2ListBox プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr14_2ListBox には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr14_2ListBox アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

Dr14_2ListBox.vcproj
...
Dr14_2ListBox.h
   ...
   CDr14_2ListBoxApp アプリケーション クラスを宣言します。

Dr14_2ListBox.cpp
   これは、アプリケーション クラス CDr14_2ListBoxApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr14_2ListBox.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル Dr14_2ListBox.rc に含まれていま
   す。

res\Dr14_2ListBox.rc2
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr14_2ListBox.rc ファイル内
...
Dr14_2ListBoxDoc.h, Dr14_2ListBoxDoc.cpp - ドキュメント
   これらのファイルは CDr14_2ListBoxDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr14_2ListBoxDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr14_2ListBoxView.h, Dr14_2ListBoxView.cpp - ドキュメントのビュー
   これらのファイルは CDr14_2ListBoxView クラスを含みます。
   CDr14_2ListBoxView オブジェクトは CDr14_2ListBoxDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr14_2ListBox.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
