================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei11 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei11 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei11 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei11.h
   ...
   CRei11App アプリケーション クラスを宣言します。

Rei11.cpp
   これは、アプリケーション クラス CRei11App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei11.ico
   ...
   アイコンはメイン リソース ファイル Rei11.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei11.rc ファイル内
...
Rei11Doc.h, Rei11Doc.cpp - ドキュメント
   これらのファイルは CRei11Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei11Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei11View.h, Rei11View.cpp - ドキュメントのビュー
   これらのファイルは CRei11View クラスを含みます。
   CRei11View オブジェクトは CRei11Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei11.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
