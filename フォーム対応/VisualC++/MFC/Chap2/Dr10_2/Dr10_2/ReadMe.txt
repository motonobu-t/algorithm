================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr10_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr10_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr10_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr10_2.h
   ...
   CDr10_2App アプリケーション クラスを宣言します。

Dr10_2.cpp
   これは、アプリケーション クラス CDr10_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr10_2.ico
   ...
   アイコンはメイン リソース ファイル Dr10_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr10_2.rc ファイル内
...
Dr10_2Doc.h, Dr10_2Doc.cpp - ドキュメント
   これらのファイルは CDr10_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr10_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr10_2View.h, Dr10_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr10_2View クラスを含みます。
   CDr10_2View オブジェクトは CDr10_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr10_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
