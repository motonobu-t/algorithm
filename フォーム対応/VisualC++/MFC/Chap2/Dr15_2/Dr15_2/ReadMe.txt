================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr15_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr15_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr15_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr15_2.h
   ...
   CDr15_2App アプリケーション クラスを宣言します。

Dr15_2.cpp
   これは、アプリケーション クラス CDr15_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr15_2.ico
   ...
   アイコンはメイン リソース ファイル Dr15_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr15_2.rc ファイル内
...
Dr15_2Doc.h, Dr15_2Doc.cpp - ドキュメント
   これらのファイルは CDr15_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr15_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr15_2View.h, Dr15_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr15_2View クラスを含みます。
   CDr15_2View オブジェクトは CDr15_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr15_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
