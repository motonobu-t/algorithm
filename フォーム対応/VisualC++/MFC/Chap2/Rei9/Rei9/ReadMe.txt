================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei9 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei9 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei9 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei9.h
   ...
   CRei9App アプリケーション クラスを宣言します。

Rei9.cpp
   これは、アプリケーション クラス CRei9App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei9.ico
   ...
   アイコンはメイン リソース ファイル Rei9.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei9.rc ファイル内
...
Rei9Doc.h, Rei9Doc.cpp - ドキュメント
   これらのファイルは CRei9Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei9Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei9View.h, Rei9View.cpp - ドキュメントのビュー
   これらのファイルは CRei9View クラスを含みます。
   CRei9View オブジェクトは CRei9Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei9.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
