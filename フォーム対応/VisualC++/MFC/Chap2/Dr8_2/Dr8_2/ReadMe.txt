================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr8_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr8_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr8_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr8_2.h
   ...
   CDr8_2App アプリケーション クラスを宣言します。

Dr8_2.cpp
   これは、アプリケーション クラス CDr8_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr8_2.ico
   ...
   アイコンはメイン リソース ファイル Dr8_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr8_2.rc ファイル内
...
Dr8_2Doc.h, Dr8_2Doc.cpp - ドキュメント
   これらのファイルは CDr8_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr8_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr8_2View.h, Dr8_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr8_2View クラスを含みます。
   CDr8_2View オブジェクトは CDr8_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr8_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
