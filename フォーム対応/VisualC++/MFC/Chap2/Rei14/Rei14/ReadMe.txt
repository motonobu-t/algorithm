================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei14 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei14 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei14 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei14.h
   ...
   CRei14App アプリケーション クラスを宣言します。

Rei14.cpp
   これは、アプリケーション クラス CRei14App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei14.ico
   ...
   アイコンはメイン リソース ファイル Rei14.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei14.rc ファイル内
...
Rei14Doc.h, Rei14Doc.cpp - ドキュメント
   これらのファイルは CRei14Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei14Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei14View.h, Rei14View.cpp - ドキュメントのビュー
   これらのファイルは CRei14View クラスを含みます。
   CRei14View オブジェクトは CRei14Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei14.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
