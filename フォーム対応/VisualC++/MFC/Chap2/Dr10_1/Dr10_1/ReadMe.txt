================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr10_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr10_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr10_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr10_1.h
   ...
   CDr10_1App アプリケーション クラスを宣言します。

Dr10_1.cpp
   これは、アプリケーション クラス CDr10_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr10_1.ico
   ...
   アイコンはメイン リソース ファイル Dr10_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr10_1.rc ファイル内
...
Dr10_1Doc.h, Dr10_1Doc.cpp - ドキュメント
   これらのファイルは CDr10_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr10_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr10_1View.h, Dr10_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr10_1View クラスを含みます。
   CDr10_1View オブジェクトは CDr10_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr10_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
