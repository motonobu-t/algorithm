================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr14_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr14_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr14_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr14_2.h
   ...
   CDr14_2App アプリケーション クラスを宣言します。

Dr14_2.cpp
   これは、アプリケーション クラス CDr14_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr14_2.ico
   ...
   アイコンはメイン リソース ファイル Dr14_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr14_2.rc ファイル内
...
Dr14_2Doc.h, Dr14_2Doc.cpp - ドキュメント
   これらのファイルは CDr14_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr14_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr14_2View.h, Dr14_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr14_2View クラスを含みます。
   CDr14_2View オブジェクトは CDr14_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr14_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
