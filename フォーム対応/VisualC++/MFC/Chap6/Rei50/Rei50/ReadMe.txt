================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei50 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei50 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei50 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei50.h
   ...
   CRei50App アプリケーション クラスを宣言します。

Rei50.cpp
   これは、アプリケーション クラス CRei50App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei50.ico
   ...
   アイコンはメイン リソース ファイル Rei50.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei50.rc ファイル内
...
Rei50Doc.h, Rei50Doc.cpp - ドキュメント
   これらのファイルは CRei50Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei50Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei50View.h, Rei50View.cpp - ドキュメントのビュー
   これらのファイルは CRei50View クラスを含みます。
   CRei50View オブジェクトは CRei50Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei50.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
