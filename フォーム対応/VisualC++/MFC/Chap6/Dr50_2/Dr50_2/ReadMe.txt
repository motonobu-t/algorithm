================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr50_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr50_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr50_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr50_2.h
   ...
   CDr50_2App アプリケーション クラスを宣言します。

Dr50_2.cpp
   これは、アプリケーション クラス CDr50_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr50_2.ico
   ...
   アイコンはメイン リソース ファイル Dr50_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr50_2.rc ファイル内
...
Dr50_2Doc.h, Dr50_2Doc.cpp - ドキュメント
   これらのファイルは CDr50_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr50_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr50_2View.h, Dr50_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr50_2View クラスを含みます。
   CDr50_2View オブジェクトは CDr50_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr50_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
