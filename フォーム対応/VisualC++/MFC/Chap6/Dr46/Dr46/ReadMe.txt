================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr46 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr46 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr46 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr46.h
   ...
   CDr46App アプリケーション クラスを宣言します。

Dr46.cpp
   これは、アプリケーション クラス CDr46App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr46.ico
   ...
   アイコンはメイン リソース ファイル Dr46.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr46.rc ファイル内
...
Dr46Doc.h, Dr46Doc.cpp - ドキュメント
   これらのファイルは CDr46Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr46Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr46View.h, Dr46View.cpp - ドキュメントのビュー
   これらのファイルは CDr46View クラスを含みます。
   CDr46View オブジェクトは CDr46Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr46.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
