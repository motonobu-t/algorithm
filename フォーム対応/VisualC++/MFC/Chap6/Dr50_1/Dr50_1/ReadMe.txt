================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr50_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr50_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr50_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr50_1.h
   ...
   CDr50_1App アプリケーション クラスを宣言します。

Dr50_1.cpp
   これは、アプリケーション クラス CDr50_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr50_1.ico
   ...
   アイコンはメイン リソース ファイル Dr50_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr50_1.rc ファイル内
...
Dr50_1Doc.h, Dr50_1Doc.cpp - ドキュメント
   これらのファイルは CDr50_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr50_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr50_1View.h, Dr50_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr50_1View クラスを含みます。
   CDr50_1View オブジェクトは CDr50_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr50_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
