================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei49 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei49 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei49 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei49.h
   ...
   CRei49App アプリケーション クラスを宣言します。

Rei49.cpp
   これは、アプリケーション クラス CRei49App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei49.ico
   ...
   アイコンはメイン リソース ファイル Rei49.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei49.rc ファイル内
...
Rei49Doc.h, Rei49Doc.cpp - ドキュメント
   これらのファイルは CRei49Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei49Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei49View.h, Rei49View.cpp - ドキュメントのビュー
   これらのファイルは CRei49View クラスを含みます。
   CRei49View オブジェクトは CRei49Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei49.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
