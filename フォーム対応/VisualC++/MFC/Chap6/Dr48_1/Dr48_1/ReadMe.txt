================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr48_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr48_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr48_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr48_1.h
   ...
   CDr48_1App アプリケーション クラスを宣言します。

Dr48_1.cpp
   これは、アプリケーション クラス CDr48_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr48_1.ico
   ...
   アイコンはメイン リソース ファイル Dr48_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr48_1.rc ファイル内
...
Dr48_1Doc.h, Dr48_1Doc.cpp - ドキュメント
   これらのファイルは CDr48_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr48_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr48_1View.h, Dr48_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr48_1View クラスを含みます。
   CDr48_1View オブジェクトは CDr48_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr48_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
