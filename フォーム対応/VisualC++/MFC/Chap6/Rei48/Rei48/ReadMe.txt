================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei48 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei48 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei48 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei48.h
   ...
   CRei48App アプリケーション クラスを宣言します。

Rei48.cpp
   これは、アプリケーション クラス CRei48App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei48.ico
   ...
   アイコンはメイン リソース ファイル Rei48.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei48.rc ファイル内
...
Rei48Doc.h, Rei48Doc.cpp - ドキュメント
   これらのファイルは CRei48Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei48Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei48View.h, Rei48View.cpp - ドキュメントのビュー
   これらのファイルは CRei48View クラスを含みます。
   CRei48View オブジェクトは CRei48Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei48.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
