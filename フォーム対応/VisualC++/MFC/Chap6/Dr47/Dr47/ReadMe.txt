================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr47 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr47 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr47 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr47.h
   ...
   CDr47App アプリケーション クラスを宣言します。

Dr47.cpp
   これは、アプリケーション クラス CDr47App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr47.ico
   ...
   アイコンはメイン リソース ファイル Dr47.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr47.rc ファイル内
...
Dr47Doc.h, Dr47Doc.cpp - ドキュメント
   これらのファイルは CDr47Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr47Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr47View.h, Dr47View.cpp - ドキュメントのビュー
   これらのファイルは CDr47View クラスを含みます。
   CDr47View オブジェクトは CDr47Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr47.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
