================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr48_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr48_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr48_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr48_2.h
   ...
   CDr48_2App アプリケーション クラスを宣言します。

Dr48_2.cpp
   これは、アプリケーション クラス CDr48_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr48_2.ico
   ...
   アイコンはメイン リソース ファイル Dr48_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr48_2.rc ファイル内
...
Dr48_2Doc.h, Dr48_2Doc.cpp - ドキュメント
   これらのファイルは CDr48_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr48_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr48_2View.h, Dr48_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr48_2View クラスを含みます。
   CDr48_2View オブジェクトは CDr48_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr48_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
