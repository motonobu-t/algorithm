================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr45_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr45_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr45_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr45_1.h
   ...
   CDr45_1App アプリケーション クラスを宣言します。

Dr45_1.cpp
   これは、アプリケーション クラス CDr45_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr45_1.ico
   ...
   アイコンはメイン リソース ファイル Dr45_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr45_1.rc ファイル内
...
Dr45_1Doc.h, Dr45_1Doc.cpp - ドキュメント
   これらのファイルは CDr45_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr45_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr45_1View.h, Dr45_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr45_1View クラスを含みます。
   CDr45_1View オブジェクトは CDr45_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr45_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
