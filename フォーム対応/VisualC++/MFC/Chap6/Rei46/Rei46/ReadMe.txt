================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei46 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei46 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei46 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei46.h
   ...
   CRei46App アプリケーション クラスを宣言します。

Rei46.cpp
   これは、アプリケーション クラス CRei46App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei46.ico
   ...
   アイコンはメイン リソース ファイル Rei46.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei46.rc ファイル内
...
Rei46Doc.h, Rei46Doc.cpp - ドキュメント
   これらのファイルは CRei46Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei46Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei46View.h, Rei46View.cpp - ドキュメントのビュー
   これらのファイルは CRei46View クラスを含みます。
   CRei46View オブジェクトは CRei46Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei46.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
