================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr45_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr45_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr45_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr45_2.h
   ...
   CDr45_2App アプリケーション クラスを宣言します。

Dr45_2.cpp
   これは、アプリケーション クラス CDr45_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr45_2.ico
   ...
   アイコンはメイン リソース ファイル Dr45_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr45_2.rc ファイル内
...
Dr45_2Doc.h, Dr45_2Doc.cpp - ドキュメント
   これらのファイルは CDr45_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr45_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr45_2View.h, Dr45_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr45_2View クラスを含みます。
   CDr45_2View オブジェクトは CDr45_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr45_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
