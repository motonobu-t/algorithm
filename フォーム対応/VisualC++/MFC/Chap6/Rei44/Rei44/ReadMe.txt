================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei44 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei44 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei44 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei44.h
   ...
   CRei44App アプリケーション クラスを宣言します。

Rei44.cpp
   これは、アプリケーション クラス CRei44App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei44.ico
   ...
   アイコンはメイン リソース ファイル Rei44.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei44.rc ファイル内
...
Rei44Doc.h, Rei44Doc.cpp - ドキュメント
   これらのファイルは CRei44Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei44Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei44View.h, Rei44View.cpp - ドキュメントのビュー
   これらのファイルは CRei44View クラスを含みます。
   CRei44View オブジェクトは CRei44Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei44.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
