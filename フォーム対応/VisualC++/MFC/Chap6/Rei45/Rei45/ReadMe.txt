================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei45 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei45 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei45 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei45.h
   ...
   CRei45App アプリケーション クラスを宣言します。

Rei45.cpp
   これは、アプリケーション クラス CRei45App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei45.ico
   ...
   アイコンはメイン リソース ファイル Rei45.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei45.rc ファイル内
...
Rei45Doc.h, Rei45Doc.cpp - ドキュメント
   これらのファイルは CRei45Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei45Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei45View.h, Rei45View.cpp - ドキュメントのビュー
   これらのファイルは CRei45View クラスを含みます。
   CRei45View オブジェクトは CRei45Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei45.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
