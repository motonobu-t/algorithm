================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr44_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr44_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr44_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr44_1.h
   ...
   CDr44_1App アプリケーション クラスを宣言します。

Dr44_1.cpp
   これは、アプリケーション クラス CDr44_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr44_1.ico
   ...
   アイコンはメイン リソース ファイル Dr44_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr44_1.rc ファイル内
...
Dr44_1Doc.h, Dr44_1Doc.cpp - ドキュメント
   これらのファイルは CDr44_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr44_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr44_1View.h, Dr44_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr44_1View クラスを含みます。
   CDr44_1View オブジェクトは CDr44_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr44_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
