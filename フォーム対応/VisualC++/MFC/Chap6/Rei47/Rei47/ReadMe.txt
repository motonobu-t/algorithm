================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei47 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei47 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei47 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei47.h
   ...
   CRei47App アプリケーション クラスを宣言します。

Rei47.cpp
   これは、アプリケーション クラス CRei47App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei47.ico
   ...
   アイコンはメイン リソース ファイル Rei47.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei47.rc ファイル内
...
Rei47Doc.h, Rei47Doc.cpp - ドキュメント
   これらのファイルは CRei47Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei47Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei47View.h, Rei47View.cpp - ドキュメントのビュー
   これらのファイルは CRei47View クラスを含みます。
   CRei47View オブジェクトは CRei47Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei47.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
