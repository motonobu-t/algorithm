================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr49 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr49 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr49 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr49.h
   ...
   CDr49App アプリケーション クラスを宣言します。

Dr49.cpp
   これは、アプリケーション クラス CDr49App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr49.ico
   ...
   アイコンはメイン リソース ファイル Dr49.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr49.rc ファイル内
...
Dr49Doc.h, Dr49Doc.cpp - ドキュメント
   これらのファイルは CDr49Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr49Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr49View.h, Dr49View.cpp - ドキュメントのビュー
   これらのファイルは CDr49View クラスを含みます。
   CDr49View オブジェクトは CDr49Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr49.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
