================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei43 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei43 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei43 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei43.h
   ...
   CRei43App アプリケーション クラスを宣言します。

Rei43.cpp
   これは、アプリケーション クラス CRei43App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei43.ico
   ...
   アイコンはメイン リソース ファイル Rei43.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei43.rc ファイル内
...
Rei43Doc.h, Rei43Doc.cpp - ドキュメント
   これらのファイルは CRei43Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei43Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei43View.h, Rei43View.cpp - ドキュメントのビュー
   これらのファイルは CRei43View クラスを含みます。
   CRei43View オブジェクトは CRei43Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei43.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
