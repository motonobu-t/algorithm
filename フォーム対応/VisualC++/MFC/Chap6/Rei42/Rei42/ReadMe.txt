================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei42 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei42 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei42 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei42.h
   ...
   CRei42App アプリケーション クラスを宣言します。

Rei42.cpp
   これは、アプリケーション クラス CRei42App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei42.ico
   ...
   アイコンはメイン リソース ファイル Rei42.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei42.rc ファイル内
...
Rei42Doc.h, Rei42Doc.cpp - ドキュメント
   これらのファイルは CRei42Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei42Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei42View.h, Rei42View.cpp - ドキュメントのビュー
   これらのファイルは CRei42View クラスを含みます。
   CRei42View オブジェクトは CRei42Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei42.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
