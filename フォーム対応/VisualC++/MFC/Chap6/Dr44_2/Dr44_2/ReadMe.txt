================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr44_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr44_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr44_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr44_2.h
   ...
   CDr44_2App アプリケーション クラスを宣言します。

Dr44_2.cpp
   これは、アプリケーション クラス CDr44_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr44_2.ico
   ...
   アイコンはメイン リソース ファイル Dr44_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr44_2.rc ファイル内
...
Dr44_2Doc.h, Dr44_2Doc.cpp - ドキュメント
   これらのファイルは CDr44_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr44_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr44_2View.h, Dr44_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr44_2View クラスを含みます。
   CDr44_2View オブジェクトは CDr44_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr44_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
