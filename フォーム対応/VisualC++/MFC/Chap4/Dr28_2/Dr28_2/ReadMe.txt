================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr28_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr28_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr28_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr28_2.h
   ...
   CDr28_2App アプリケーション クラスを宣言します。

Dr28_2.cpp
   これは、アプリケーション クラス CDr28_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr28_2.ico
   ...
   アイコンはメイン リソース ファイル Dr28_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr28_2.rc ファイル内
...
Dr28_2Doc.h, Dr28_2Doc.cpp - ドキュメント
   これらのファイルは CDr28_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr28_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr28_2View.h, Dr28_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr28_2View クラスを含みます。
   CDr28_2View オブジェクトは CDr28_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr28_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
