================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr26_5 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr26_5 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr26_5 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr26_5.h
   ...
   CDr26_5App アプリケーション クラスを宣言します。

Dr26_5.cpp
   これは、アプリケーション クラス CDr26_5App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr26_5.ico
   ...
   アイコンはメイン リソース ファイル Dr26_5.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr26_5.rc ファイル内
...
Dr26_5Doc.h, Dr26_5Doc.cpp - ドキュメント
   これらのファイルは CDr26_5Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr26_5Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr26_5View.h, Dr26_5View.cpp - ドキュメントのビュー
   これらのファイルは CDr26_5View クラスを含みます。
   CDr26_5View オブジェクトは CDr26_5Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr26_5.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
