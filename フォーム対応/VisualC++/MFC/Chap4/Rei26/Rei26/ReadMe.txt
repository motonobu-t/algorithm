================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei26 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei26 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei26 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei26.h
   ...
   CRei26App アプリケーション クラスを宣言します。

Rei26.cpp
   これは、アプリケーション クラス CRei26App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei26.ico
   ...
   アイコンはメイン リソース ファイル Rei26.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei26.rc ファイル内
...
Rei26Doc.h, Rei26Doc.cpp - ドキュメント
   これらのファイルは CRei26Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei26Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei26View.h, Rei26View.cpp - ドキュメントのビュー
   これらのファイルは CRei26View クラスを含みます。
   CRei26View オブジェクトは CRei26Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei26.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
