================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr30_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr30_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr30_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr30_1.h
   ...
   CDr30_1App アプリケーション クラスを宣言します。

Dr30_1.cpp
   これは、アプリケーション クラス CDr30_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr30_1.ico
   ...
   アイコンはメイン リソース ファイル Dr30_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr30_1.rc ファイル内
...
Dr30_1Doc.h, Dr30_1Doc.cpp - ドキュメント
   これらのファイルは CDr30_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr30_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr30_1View.h, Dr30_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr30_1View クラスを含みます。
   CDr30_1View オブジェクトは CDr30_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr30_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
