================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr26_4 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr26_4 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr26_4 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr26_4.h
   ...
   CDr26_4App アプリケーション クラスを宣言します。

Dr26_4.cpp
   これは、アプリケーション クラス CDr26_4App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr26_4.ico
   ...
   アイコンはメイン リソース ファイル Dr26_4.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr26_4.rc ファイル内
...
Dr26_4Doc.h, Dr26_4Doc.cpp - ドキュメント
   これらのファイルは CDr26_4Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr26_4Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr26_4View.h, Dr26_4View.cpp - ドキュメントのビュー
   これらのファイルは CDr26_4View クラスを含みます。
   CDr26_4View オブジェクトは CDr26_4Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr26_4.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
