================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr30_3 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr30_3 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr30_3 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr30_3.h
   ...
   CDr30_3App アプリケーション クラスを宣言します。

Dr30_3.cpp
   これは、アプリケーション クラス CDr30_3App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr30_3.ico
   ...
   アイコンはメイン リソース ファイル Dr30_3.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr30_3.rc ファイル内
...
Dr30_3Doc.h, Dr30_3Doc.cpp - ドキュメント
   これらのファイルは CDr30_3Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr30_3Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr30_3View.h, Dr30_3View.cpp - ドキュメントのビュー
   これらのファイルは CDr30_3View クラスを含みます。
   CDr30_3View オブジェクトは CDr30_3Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr30_3.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
