================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr26_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr26_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr26_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr26_2.h
   ...
   CDr26_2App アプリケーション クラスを宣言します。

Dr26_2.cpp
   これは、アプリケーション クラス CDr26_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr26_2.ico
   ...
   アイコンはメイン リソース ファイル Dr26_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr26_2.rc ファイル内
...
Dr26_2Doc.h, Dr26_2Doc.cpp - ドキュメント
   これらのファイルは CDr26_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr26_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr26_2View.h, Dr26_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr26_2View クラスを含みます。
   CDr26_2View オブジェクトは CDr26_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr26_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
