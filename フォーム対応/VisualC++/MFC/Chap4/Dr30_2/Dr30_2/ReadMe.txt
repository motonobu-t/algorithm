================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr30_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr30_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr30_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr30_2.h
   ...
   CDr30_2App アプリケーション クラスを宣言します。

Dr30_2.cpp
   これは、アプリケーション クラス CDr30_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr30_2.ico
   ...
   アイコンはメイン リソース ファイル Dr30_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr30_2.rc ファイル内
...
Dr30_2Doc.h, Dr30_2Doc.cpp - ドキュメント
   これらのファイルは CDr30_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr30_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr30_2View.h, Dr30_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr30_2View クラスを含みます。
   CDr30_2View オブジェクトは CDr30_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr30_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
