================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei31 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei31 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei31 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei31.h
   ...
   CRei31App アプリケーション クラスを宣言します。

Rei31.cpp
   これは、アプリケーション クラス CRei31App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei31.ico
   ...
   アイコンはメイン リソース ファイル Rei31.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei31.rc ファイル内
...
Rei31Doc.h, Rei31Doc.cpp - ドキュメント
   これらのファイルは CRei31Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei31Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei31View.h, Rei31View.cpp - ドキュメントのビュー
   これらのファイルは CRei31View クラスを含みます。
   CRei31View オブジェクトは CRei31Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei31.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
