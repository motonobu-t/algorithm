================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr28_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr28_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr28_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr28_1.h
   ...
   CDr28_1App アプリケーション クラスを宣言します。

Dr28_1.cpp
   これは、アプリケーション クラス CDr28_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr28_1.ico
   ...
   アイコンはメイン リソース ファイル Dr28_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr28_1.rc ファイル内
...
Dr28_1Doc.h, Dr28_1Doc.cpp - ドキュメント
   これらのファイルは CDr28_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr28_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr28_1View.h, Dr28_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr28_1View クラスを含みます。
   CDr28_1View オブジェクトは CDr28_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr28_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
