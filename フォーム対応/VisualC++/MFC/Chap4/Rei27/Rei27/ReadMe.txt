================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei27 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei27 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei27 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei27.h
   ...
   CRei27App アプリケーション クラスを宣言します。

Rei27.cpp
   これは、アプリケーション クラス CRei27App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei27.ico
   ...
   アイコンはメイン リソース ファイル Rei27.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei27.rc ファイル内
...
Rei27Doc.h, Rei27Doc.cpp - ドキュメント
   これらのファイルは CRei27Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei27Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei27View.h, Rei27View.cpp - ドキュメントのビュー
   これらのファイルは CRei27View クラスを含みます。
   CRei27View オブジェクトは CRei27Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei27.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
