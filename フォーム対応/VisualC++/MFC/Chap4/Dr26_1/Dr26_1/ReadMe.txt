================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr26_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr26_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr26_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr26_1.h
   ...
   CDr26_1App アプリケーション クラスを宣言します。

Dr26_1.cpp
   これは、アプリケーション クラス CDr26_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr26_1.ico
   ...
   アイコンはメイン リソース ファイル Dr26_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr26_1.rc ファイル内
...
Dr26_1Doc.h, Dr26_1Doc.cpp - ドキュメント
   これらのファイルは CDr26_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr26_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr26_1View.h, Dr26_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr26_1View クラスを含みます。
   CDr26_1View オブジェクトは CDr26_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr26_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
