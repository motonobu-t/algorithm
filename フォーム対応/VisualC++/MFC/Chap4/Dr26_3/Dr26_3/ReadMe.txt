================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr26_3 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr26_3 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr26_3 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr26_3.h
   ...
   CDr26_3App アプリケーション クラスを宣言します。

Dr26_3.cpp
   これは、アプリケーション クラス CDr26_3App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr26_3.ico
   ...
   アイコンはメイン リソース ファイル Dr26_3.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr26_3.rc ファイル内
...
Dr26_3Doc.h, Dr26_3Doc.cpp - ドキュメント
   これらのファイルは CDr26_3Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr26_3Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr26_3View.h, Dr26_3View.cpp - ドキュメントのビュー
   これらのファイルは CDr26_3View クラスを含みます。
   CDr26_3View オブジェクトは CDr26_3Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr26_3.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
