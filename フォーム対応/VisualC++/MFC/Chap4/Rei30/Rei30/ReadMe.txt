================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei30 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei30 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei30 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei30.h
   ...
   CRei30App アプリケーション クラスを宣言します。

Rei30.cpp
   これは、アプリケーション クラス CRei30App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei30.ico
   ...
   アイコンはメイン リソース ファイル Rei30.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei30.rc ファイル内
...
Rei30Doc.h, Rei30Doc.cpp - ドキュメント
   これらのファイルは CRei30Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei30Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei30View.h, Rei30View.cpp - ドキュメントのビュー
   これらのファイルは CRei30View クラスを含みます。
   CRei30View オブジェクトは CRei30Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei30.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
