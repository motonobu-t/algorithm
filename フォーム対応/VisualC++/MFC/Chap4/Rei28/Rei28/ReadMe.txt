================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei28 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei28 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei28 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei28.h
   ...
   CRei28App アプリケーション クラスを宣言します。

Rei28.cpp
   これは、アプリケーション クラス CRei28App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei28.ico
   ...
   アイコンはメイン リソース ファイル Rei28.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei28.rc ファイル内
...
Rei28Doc.h, Rei28Doc.cpp - ドキュメント
   これらのファイルは CRei28Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei28Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei28View.h, Rei28View.cpp - ドキュメントのビュー
   これらのファイルは CRei28View クラスを含みます。
   CRei28View オブジェクトは CRei28Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei28.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
