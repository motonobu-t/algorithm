...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(6, 14);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(71, 13);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(134, 13);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(49, 18);
			...
			this->pictureBox1->Location = System::Drawing::Point(7, 47);
