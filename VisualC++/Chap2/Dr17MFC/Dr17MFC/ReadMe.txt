================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr17MFC プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr17MFC には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr17MFC アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr17MFC.h
   ...
   CDr17MFCApp アプリケーション クラスを宣言します。

Dr17MFC.cpp
   これは、アプリケーション クラス CDr17MFCApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr17MFC.ico
   ...
   アイコンはメイン リソース ファイル Dr17MFC.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr17MFC.rc ファイル内
...
Dr17MFCDoc.h, Dr17MFCDoc.cpp - ドキュメント
   これらのファイルは CDr17MFCDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr17MFCDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr17MFCView.h, Dr17MFCView.cpp - ドキュメントのビュー
   これらのファイルは CDr17MFCView クラスを含みます。
   CDr17MFCView オブジェクトは CDr17MFCDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr17MFC.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
