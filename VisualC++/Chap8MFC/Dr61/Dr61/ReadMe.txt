================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr61 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr61 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr61 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr61.h
   ...
   CDr61App アプリケーション クラスを宣言します。

Dr61.cpp
   これは、アプリケーション クラス CDr61App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr61.ico
   ...
   アイコンはメイン リソース ファイル Dr61.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr61.rc ファイル内
...
Dr61Doc.h, Dr61Doc.cpp - ドキュメント
   これらのファイルは CDr61Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr61Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr61View.h, Dr61View.cpp - ドキュメントのビュー
   これらのファイルは CDr61View クラスを含みます。
   CDr61View オブジェクトは CDr61Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr61.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
