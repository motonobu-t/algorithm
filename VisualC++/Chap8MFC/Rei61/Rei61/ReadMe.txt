================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei61 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei61 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei61 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei61.h
   ...
   CRei61App アプリケーション クラスを宣言します。

Rei61.cpp
   これは、アプリケーション クラス CRei61App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei61.ico
   ...
   アイコンはメイン リソース ファイル Rei61.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei61.rc ファイル内
...
Rei61Doc.h, Rei61Doc.cpp - ドキュメント
   これらのファイルは CRei61Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei61Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei61View.h, Rei61View.cpp - ドキュメントのビュー
   これらのファイルは CRei61View クラスを含みます。
   CRei61View オブジェクトは CRei61Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei61.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
