================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei63 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei63 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei63 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei63.h
   ...
   CRei63App アプリケーション クラスを宣言します。

Rei63.cpp
   これは、アプリケーション クラス CRei63App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei63.ico
   ...
   アイコンはメイン リソース ファイル Rei63.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei63.rc ファイル内
...
Rei63Doc.h, Rei63Doc.cpp - ドキュメント
   これらのファイルは CRei63Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei63Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei63View.h, Rei63View.cpp - ドキュメントのビュー
   これらのファイルは CRei63View クラスを含みます。
   CRei63View オブジェクトは CRei63Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei63.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
