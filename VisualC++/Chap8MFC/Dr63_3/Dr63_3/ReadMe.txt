================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr63_3 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr63_3 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr63_3 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr63_3.h
   ...
   CDr63_3App アプリケーション クラスを宣言します。

Dr63_3.cpp
   これは、アプリケーション クラス CDr63_3App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr63_3.ico
   ...
   アイコンはメイン リソース ファイル Dr63_3.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr63_3.rc ファイル内
...
Dr63_3Doc.h, Dr63_3Doc.cpp - ドキュメント
   これらのファイルは CDr63_3Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr63_3Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr63_3View.h, Dr63_3View.cpp - ドキュメントのビュー
   これらのファイルは CDr63_3View クラスを含みます。
   CDr63_3View オブジェクトは CDr63_3Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr63_3.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
