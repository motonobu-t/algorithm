================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr63_1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr63_1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr63_1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr63_1.h
   ...
   CDr63_1App アプリケーション クラスを宣言します。

Dr63_1.cpp
   これは、アプリケーション クラス CDr63_1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr63_1.ico
   ...
   アイコンはメイン リソース ファイル Dr63_1.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr63_1.rc ファイル内
...
Dr63_1Doc.h, Dr63_1Doc.cpp - ドキュメント
   これらのファイルは CDr63_1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr63_1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr63_1View.h, Dr63_1View.cpp - ドキュメントのビュー
   これらのファイルは CDr63_1View クラスを含みます。
   CDr63_1View オブジェクトは CDr63_1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr63_1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
