================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei57 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei57 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei57 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei57.h
   ...
   CRei57App アプリケーション クラスを宣言します。

Rei57.cpp
   これは、アプリケーション クラス CRei57App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei57.ico
   ...
   アイコンはメイン リソース ファイル Rei57.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei57.rc ファイル内
...
Rei57Doc.h, Rei57Doc.cpp - ドキュメント
   これらのファイルは CRei57Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei57Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei57View.h, Rei57View.cpp - ドキュメントのビュー
   これらのファイルは CRei57View クラスを含みます。
   CRei57View オブジェクトは CRei57Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei57.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
