================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Rei59 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Rei59 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Rei59 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Rei59.h
   ...
   CRei59App アプリケーション クラスを宣言します。

Rei59.cpp
   これは、アプリケーション クラス CRei59App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Rei59.ico
   ...
   アイコンはメイン リソース ファイル Rei59.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Rei59.rc ファイル内
...
Rei59Doc.h, Rei59Doc.cpp - ドキュメント
   これらのファイルは CRei59Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CRei59Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Rei59View.h, Rei59View.cpp - ドキュメントのビュー
   これらのファイルは CRei59View クラスを含みます。
   CRei59View オブジェクトは CRei59Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Rei59.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
