================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Dr62_2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Dr62_2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Dr62_2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Dr62_2.h
   ...
   CDr62_2App アプリケーション クラスを宣言します。

Dr62_2.cpp
   これは、アプリケーション クラス CDr62_2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Dr62_2.ico
   ...
   アイコンはメイン リソース ファイル Dr62_2.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Dr62_2.rc ファイル内
...
Dr62_2Doc.h, Dr62_2Doc.cpp - ドキュメント
   これらのファイルは CDr62_2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CDr62_2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Dr62_2View.h, Dr62_2View.cpp - ドキュメントのビュー
   これらのファイルは CDr62_2View クラスを含みます。
   CDr62_2View オブジェクトは CDr62_2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Dr62_2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
